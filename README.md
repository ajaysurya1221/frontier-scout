<!--
  ...
  fonts / CSS / animation, so they render identically on GitHub light & dark. GitHub strips
  <style>/<script>/class/style= from README HTML, so richness lives in baked SVG assets +
  plain markdown (tables, <details>, <kbd>, > [!TIP]). Headers are plain text (no emoji) so
  heading anchors stay reliable. Structure inspired by othneildrew/Best-README-Template (MIT).
...
<p>
  ...
  &nbsp;
  <img alt="status: research preview" src="https://img.shields.io/badge/status-research%20preview-24d6a8?style=for-the-badge&labelColor=05080b">
  &nbsp;
  <img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-a9bccd?style=for-the-badge&labelColor=05080b">
  &nbsp;
  <img alt="telemetry: none" src="https://img.shields.io/badge/telemetry-none-e3c26f?style=for-the-badge&labelColor=05080b">
</p>
...
<img src="docs/assets/what-you-get.svg" alt="What you get. Repo-ranked curation: the servers that matter to your code rise first; local tree-sitter; your source never leaves the machine. Static safety + risk-gating: a capability and policy map per server; write/shell/credential/network need a risk acknowledgement; no server is executed. Managed-config export: the approved set becomes a Claude Code allow/deny fragment an admin deploys; it emits, it does not enforce." width="100%">
